...
public class WordProgram implements Program{
	...
	public void runMenu(int menu) {
		switch(menu) {
		case 1 : // 등록은 단어, 뜻, 품사를 한번에 입력해야 등록되도록 구현
			insertManager();	break;
			
		case 2 : // 수정은 단어, 뜻, 품사를 각각 수정 가능하도록 구현
			updateManager();	break;
			
		case 3 : // 삭제는 단어, 뜻, 품사를 각각 수정 가능하도록 구현
			deleteManager();	break;
			
		case 4 : // 조회는 단어, 뜻, 품사가 한번에 보이도록 구현
			printManager();		break;
	...
	private void wordGame() {
		...
		do {
			...
			//랜덤 인덱스 단어 출력
			System.out.print(list.get(r).getWord() + "의 뜻은? (게임 종료를 원할 시 1을 입력하세요.) \n답 : ");
			//뜻 입력받기
			answer = scan.next();
